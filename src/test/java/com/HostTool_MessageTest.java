...
public class HostTool_MessageTest extends BasicTest {
    ...
    HostTool_AllListingsPage allListingsPage = new
    HostTool_AllListingsPage(driver);
    HostTool_AddMessageNewPage addMessageNewPage = new
    HostTool_AddMessageNewPage(driver);
